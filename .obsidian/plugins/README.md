...
These are committed so the vault is self-contained — clone and open in Obsidian, no plugin
downloads. They are unmodified release builds from each project's GitHub releases. Enable them in
`.obsidian/community-plugins.json` (already done).

| Plugin | id | Version | Source | License |
| --- | --- | --- | --- | --- |
