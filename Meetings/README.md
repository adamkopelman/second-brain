...
items into the note — see `docs/gtd/meeting-recording.md`. You can also record from the local
dashboard (`python scripts/dashboard_server.py`): press `r` or click **● Record**; it's transcribed
automatically.
